...
const SHELL_FLOOR = { 快档: 3, 补给档: 20 };

/* 一批补给出多少条文案。提示词和闸门必须用同一个数：模型照闸门给，不照提示词给。 */
...
function refillShellsPrompt({ customer, huntPack, copies, battlefields, compliance }) {
...
这一份给【补给档】出平台外壳：这一批的 ${REFILL_COPIES} 条文案已经出好了，你的活是把它们翻译成各平台能直接上的成品。
